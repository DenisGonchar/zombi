...
#include "TDAInventoryComponent.generated.h"
...
class TDA_API UTDAInventoryComponent : public UActorComponent
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UTDAInventoryComponent();
...
public:	
	...
	bool CheckCanTakeAmmo(EWeaponType AmmoTypo);
